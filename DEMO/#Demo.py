...
ResetBtt = ImageTk.PhotoImage(Image.open(r'YourSynthDEMO\ImageSources\Reload-09.png'))
...
def reset(nmvco):
    if(nmvco == 1):
        boton1S = tkinter.Button(image = Sine, command= lambda: asignar(1, vco3,7), relief = FLAT)
        boton1S.place(x = 330, y = 87, height = 70, width = 70)
        boton1Sq = tkinter.Button(image = Square, command= lambda: asignar(2, vco3,8), relief = FLAT)
        boton1Sq.place(x = 427, y = 87, height = 70, width = 70)
        boton1Sa = tkinter.Button(image = Saw, command= lambda: asignar(3, vco3,9), relief = FLAT)
        boton1Sa.place(x = 524, y = 87, height = 70, width = 70)
        vco1.onda = 0
    elif (nmvco == 2):
        boton2S = tkinter.Button(image = Sine, command= lambda: asignar(1, vco3,7), relief = FLAT)
        boton2S.place(x = 330, y = 186, height = 70, width = 70)
        boton2Sq = tkinter.Button(image = Square, command= lambda: asignar(2, vco3,8), relief = FLAT)
        boton2Sq.place(x = 427, y = 186, height = 70, width = 70)
        boton2Sa = tkinter.Button(image = Saw, command= lambda: asignar(3, vco3,9), relief = FLAT)
        boton2Sa.place(x = 524, y = 186, height = 70, width = 70)
        vco2.onda = 0
    elif (nmvco == 3):
        boton3S = tkinter.Button(image = Sine, command= lambda: asignar(1, vco3,7), relief = FLAT)
